...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.SIMPLEPETRINET_NET_INITIALIZE: {
				Simplepetrinet_Net_Initialize simplepetrinet_Net_Initialize = (Simplepetrinet_Net_Initialize)theEObject;
				T result = caseSimplepetrinet_Net_Initialize(simplepetrinet_Net_Initialize);
				if (result == null) result = caseSmallStep(simplepetrinet_Net_Initialize);
				if (result == null) result = caseStep(simplepetrinet_Net_Initialize);
				if (result == null) result = caseMSEOccurrence(simplepetrinet_Net_Initialize);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.SIMPLEPETRINET_TRANSITION_FIRE: {
				Simplepetrinet_Transition_Fire simplepetrinet_Transition_Fire = (Simplepetrinet_Transition_Fire)theEObject;
				T result = caseSimplepetrinet_Transition_Fire(simplepetrinet_Transition_Fire);
				if (result == null) result = caseSmallStep(simplepetrinet_Transition_Fire);
				if (result == null) result = caseStep(simplepetrinet_Transition_Fire);
				if (result == null) result = caseMSEOccurrence(simplepetrinet_Transition_Fire);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simplepetrinet Net Initialize</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simplepetrinet Net Initialize</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimplepetrinet_Net_Initialize(Simplepetrinet_Net_Initialize object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simplepetrinet Transition Fire</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simplepetrinet Transition Fire</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimplepetrinet_Transition_Fire(Simplepetrinet_Transition_Fire object) {
		return null;
	}
