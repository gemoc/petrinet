...
public class StepsFactoryImpl extends EFactoryImpl implements StepsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StepsPackage.SIMPLEPETRINET_NET_INITIALIZE: return createSimplepetrinet_Net_Initialize();
			case StepsPackage.SIMPLEPETRINET_TRANSITION_FIRE: return createSimplepetrinet_Transition_Fire();
			default:
	 ...
	 * @generated
	 */
	public Simplepetrinet_Net_Initialize createSimplepetrinet_Net_Initialize() {
		Simplepetrinet_Net_InitializeImpl simplepetrinet_Net_Initialize = new Simplepetrinet_Net_InitializeImpl();
		return simplepetrinet_Net_Initialize;
	}
	 ...
	 * @generated
	 */
	public Simplepetrinet_Transition_Fire createSimplepetrinet_Transition_Fire() {
		Simplepetrinet_Transition_FireImpl simplepetrinet_Transition_Fire = new Simplepetrinet_Transition_FireImpl();
		return simplepetrinet_Transition_Fire;
	}
