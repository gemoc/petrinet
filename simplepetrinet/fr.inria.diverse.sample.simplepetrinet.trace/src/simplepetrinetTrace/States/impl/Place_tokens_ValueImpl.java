 ...
 * <ul>
 *   <li>{@link simplepetrinetTrace.States.impl.Place_tokens_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link simplepetrinetTrace.States.impl.Place_tokens_ValueImpl#getStates <em>States</em>}</li>
 *   <li>{@link simplepetrinetTrace.States.impl.Place_tokens_ValueImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Place_tokens_ValueImpl extends MinimalEObjectImpl.Container implements Place_tokens_Value {
	...
	public void setParent(TracedPlace newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.PLACE_TOKENS_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, SimplepetrinetPackage.TRACED_PLACE__TOKENS_SEQUENCE, TracedPlace.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.PLACE_TOKENS_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, SimplepetrinetPackage.TRACED_PLACE__TOKENS_SEQUENCE, TracedPlace.class, msgs);
		}
