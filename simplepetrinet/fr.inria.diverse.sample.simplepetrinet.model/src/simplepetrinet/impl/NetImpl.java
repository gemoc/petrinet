 ...
 * <ul>
 *   <li>{@link simplepetrinet.impl.NetImpl#getPlaces <em>Places</em>}</li>
 *   <li>{@link simplepetrinet.impl.NetImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NetImpl extends MinimalEObjectImpl.Container implements Net {
	...
	protected EClass eStaticClass() {
		return SimplepetrinetPackage.Literals.NET;
	}
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, SimplepetrinetPackage.NET__PLACES);
		}
		return places;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, SimplepetrinetPackage.NET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimplepetrinetPackage.NET__PLACES:
				return ((InternalEList<?>)getPlaces()).basicRemove(otherEnd, msgs);
			case SimplepetrinetPackage.NET__TRANSITIONS:
