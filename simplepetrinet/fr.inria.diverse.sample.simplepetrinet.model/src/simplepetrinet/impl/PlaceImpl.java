 ...
 * <ul>
 *   <li>{@link simplepetrinet.impl.PlaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link simplepetrinet.impl.PlaceImpl#getInitialTokens <em>Initial Tokens</em>}</li>
 *   <li>{@link simplepetrinet.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends MinimalEObjectImpl.Container implements Place {
	...
	protected EClass eStaticClass() {
		return SimplepetrinetPackage.Literals.PLACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepetrinetPackage.PLACE__NAME, oldName, name));
	}
	...
	public void setInitialTokens(int newInitialTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepetrinetPackage.PLACE__INITIAL_TOKENS, oldInitialTokens, initialTokens));
	}
	...
	public void setTokens(int newTokens) {
		...
		tokens = newTokens;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplepetrinetPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimplepetrinetPackage.PLACE__NAME:
				return getName();
			case SimplepetrinetPackage.PLACE__INITIAL_TOKENS:
				return getInitialTokens();
			case SimplepetrinetPackage.PLACE__TOKENS:
				return getTokens();
		}
