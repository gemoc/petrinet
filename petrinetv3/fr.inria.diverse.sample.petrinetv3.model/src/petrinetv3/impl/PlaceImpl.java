 ...
 * <ul>
 *   <li>{@link petrinetv3.impl.PlaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link petrinetv3.impl.PlaceImpl#getInitialTokens <em>Initial Tokens</em>}</li>
 *   <li>{@link petrinetv3.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends MinimalEObjectImpl.Container implements Place {
	...
	protected EClass eStaticClass() {
		return PetrinetV3Package.Literals.PLACE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetV3Package.PLACE__NAME, oldName, name));
	}
	...
	public void setInitialTokens(int newInitialTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetV3Package.PLACE__INITIAL_TOKENS, oldInitialTokens, initialTokens));
	}
	...
	public EList<Token> getTokens() {
		if (tokens == null) {
			tokens = new EObjectContainmentEList<Token>(Token.class, this, PetrinetV3Package.PLACE__TOKENS);
		}
		return tokens;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetV3Package.PLACE__TOKENS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetrinetV3Package.PLACE__NAME:
				return getName();
			case PetrinetV3Package.PLACE__INITIAL_TOKENS:
