...
public class PetrinetV3PackageImpl extends EPackageImpl implements PetrinetV3Package {
	 ...
	 * @see petrinetv3.PetrinetV3Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getTransition_Tmin() {
	 ...
	 * @generated
	 */
	public EAttribute getTransition_Tmax() {
	 ...
	 * @generated
	 */
	public EAttribute getTransition_Clock() {
	 ...
	 * @generated
	 */
	public EReference getTransition_ParentNet() {
	...
	public void createPackageContents() {
		...
		createEAttribute(transitionEClass, TRANSITION__TMIN);
		createEAttribute(transitionEClass, TRANSITION__TMAX);
		createEAttribute(transitionEClass, TRANSITION__CLOCK);
		createEReference(transitionEClass, TRANSITION__PARENT_NET);
	...
	public void initializePackageContents() {
		...
		initEReference(getNet_Transitions(), this.getTransition(), this.getTransition_ParentNet(), "transitions", null, 0, -1, Net.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTransition_Tmin(), ecorePackage.getEInt(), "tmin", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransition_Tmax(), ecorePackage.getEInt(), "tmax", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransition_Clock(), ecorePackage.getEInt(), "clock", "-1", 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_ParentNet(), this.getNet(), this.getNet_Transitions(), "parentNet", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
