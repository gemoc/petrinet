 ...
 * <ul>
 *   <li>{@link petrinetv3Trace.States.impl.StateImpl#getEndedSteps <em>Ended Steps</em>}</li>
 *   <li>{@link petrinetv3Trace.States.impl.StateImpl#getPlace_tokens_Values <em>Place tokens Values</em>}</li>
 *   <li>{@link petrinetv3Trace.States.impl.StateImpl#getStartedSteps <em>Started Steps</em>}</li>
 *   <li>{@link petrinetv3Trace.States.impl.StateImpl#getTransition_clock_Values <em>Transition clock Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	/**
	 * The cached value of the '{@link #getTransition_clock_Values() <em>Transition clock Values</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTransition_clock_Values()
	 * @generated
	 * @ordered
	 */
	protected EList<Transition_clock_Value> transition_clock_Values;
	 ...
	 * @generated
	 */
	public EList<Transition_clock_Value> getTransition_clock_Values() {
		if (transition_clock_Values == null) {
			transition_clock_Values = new EObjectWithInverseResolvingEList.ManyInverse<Transition_clock_Value>(Transition_clock_Value.class, this, StatesPackage.STATE__TRANSITION_CLOCK_VALUES, StatesPackage.TRANSITION_CLOCK_VALUE__STATES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StatesPackage.STATE__TRANSITION_CLOCK_VALUES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTransition_clock_Values()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StatesPackage.STATE__TRANSITION_CLOCK_VALUES:
				return ((InternalEList<?>)getTransition_clock_Values()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StatesPackage.STATE__TRANSITION_CLOCK_VALUES:
				return getTransition_clock_Values();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StatesPackage.STATE__STARTED_STEPS:
				...
				return;
			case StatesPackage.STATE__TRANSITION_CLOCK_VALUES:
				getTransition_clock_Values().clear();
				getTransition_clock_Values().addAll((Collection<? extends Transition_clock_Value>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case StatesPackage.STATE__TRANSITION_CLOCK_VALUES:
				return transition_clock_Values != null && !transition_clock_Values.isEmpty();
		}
