...
public class StatesFactoryImpl extends EFactoryImpl implements StatesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StatesPackage.TRANSITION_CLOCK_VALUE: return createTransition_clock_Value();
			default:
	 ...
	 * @generated
	 */
	public Transition_clock_Value createTransition_clock_Value() {
		Transition_clock_ValueImpl transition_clock_Value = new Transition_clock_ValueImpl();
		return transition_clock_Value;
	}
