 ...
 * <ul>
 *   <li>{@link petrinetv3Trace.States.petrinetv3.impl.TracedPlaceImpl#getOriginalObject <em>Original Object</em>}</li>
 *   <li>{@link petrinetv3Trace.States.petrinetv3.impl.TracedPlaceImpl#getTokens <em>Tokens</em>}</li>
 *   <li>{@link petrinetv3Trace.States.petrinetv3.impl.TracedPlaceImpl#getTokensSequence <em>Tokens Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TracedPlaceImpl extends MinimalEObjectImpl.Container implements TracedPlace {
	...
	protected EClass eStaticClass() {
		return Petrinetv3Package.Literals.TRACED_PLACE;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Petrinetv3Package.TRACED_PLACE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(Place newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinetv3Package.TRACED_PLACE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public EList<Token> getTokens() {
		if (tokens == null) {
			tokens = new EObjectResolvingEList<Token>(Token.class, this, Petrinetv3Package.TRACED_PLACE__TOKENS);
		}
		return tokens;
	}
	...
	public EList<Place_tokens_Value> getTokensSequence() {
		if (tokensSequence == null) {
			tokensSequence = new EObjectContainmentWithInverseEList<Place_tokens_Value>(Place_tokens_Value.class, this, Petrinetv3Package.TRACED_PLACE__TOKENS_SEQUENCE, StatesPackage.PLACE_TOKENS_VALUE__PARENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Petrinetv3Package.TRACED_PLACE__TOKENS_SEQUENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinetv3Package.TRACED_PLACE__ORIGINAL_OBJECT:
				if (resolve) return getOriginalObject();
				return basicGetOriginalObject();
			case Petrinetv3Package.TRACED_PLACE__TOKENS:
				return getTokens();
			case Petrinetv3Package.TRACED_PLACE__TOKENS_SEQUENCE:
