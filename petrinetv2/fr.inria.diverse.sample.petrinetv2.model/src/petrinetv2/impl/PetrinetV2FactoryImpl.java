...
public class PetrinetV2FactoryImpl extends EFactoryImpl implements PetrinetV2Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case PetrinetV2Package.NET: return createNet();
			case PetrinetV2Package.TRANSITION: return createTransition();
			case PetrinetV2Package.PLACE: return createPlace();
			case PetrinetV2Package.TOKEN: return createToken();
			default:
