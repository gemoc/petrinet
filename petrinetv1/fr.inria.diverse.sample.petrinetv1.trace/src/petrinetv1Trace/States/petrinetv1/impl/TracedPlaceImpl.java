 ...
 * <ul>
 *   <li>{@link petrinetv1Trace.States.petrinetv1.impl.TracedPlaceImpl#getOriginalObject <em>Original Object</em>}</li>
 *   <li>{@link petrinetv1Trace.States.petrinetv1.impl.TracedPlaceImpl#getTokensSequence <em>Tokens Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TracedPlaceImpl extends MinimalEObjectImpl.Container implements TracedPlace {
	...
	protected EClass eStaticClass() {
		return Petrinetv1Package.Literals.TRACED_PLACE;
	}
		...
		if (originalObject != null && originalObject.eIsProxy()) {
			...
			if (originalObject != oldOriginalObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Petrinetv1Package.TRACED_PLACE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
			}
		}
	...
	public void setOriginalObject(Place newOriginalObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Petrinetv1Package.TRACED_PLACE__ORIGINAL_OBJECT, oldOriginalObject, originalObject));
	}
	...
	public EList<Place_tokens_Value> getTokensSequence() {
		if (tokensSequence == null) {
			tokensSequence = new EObjectContainmentWithInverseEList<Place_tokens_Value>(Place_tokens_Value.class, this, Petrinetv1Package.TRACED_PLACE__TOKENS_SEQUENCE, StatesPackage.PLACE_TOKENS_VALUE__PARENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Petrinetv1Package.TRACED_PLACE__TOKENS_SEQUENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Petrinetv1Package.TRACED_PLACE__ORIGINAL_OBJECT:
