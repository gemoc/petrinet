 ...
 * <ul>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getResult <em>Result</em>}</li>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getLogicalStep <em>Logical Step</em>}</li>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link petrinetv1Trace.Steps.impl.Petrinetv1_Net_InitializeImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Petrinetv1_Net_InitializeImpl extends Petrinetv1_Net_Run_AbstractSubStepImpl implements Petrinetv1_Net_Initialize {
	/**
		...
		if (mse != null && mse.eIsProxy()) {
			...
			if (mse != oldMse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINETV1_NET_INITIALIZE__MSE, oldMse, mse));
			}
		}
		return mse;
	}
	...
	public void setMse(MSE newMse) {
		...
		mse = newMse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__MSE, oldMse, mse));
	}
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.PETRINETV1_NET_INITIALIZE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.PETRINETV1_NET_INITIALIZE__RESULT);
		}
		return result;
	}
	...
	public LogicalStep getLogicalStep() {
		if (logicalStep != null && logicalStep.eIsProxy()) {
			...
			if (logicalStep != oldLogicalStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP, oldLogicalStep, logicalStep));
			}
		}
		return logicalStep;
	}
	...
	public NotificationChain basicSetLogicalStep(LogicalStep newLogicalStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP, oldLogicalStep, newLogicalStep);
	...
	public void setLogicalStep(LogicalStep newLogicalStep) {
		if (newLogicalStep != logicalStep) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP, newLogicalStep, newLogicalStep));
	}
	...
	public State getEndingState() {
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE, oldEndingState, newEndingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE, newStartingState, newStartingState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP:
				if (logicalStep != null)
					msgs = ((InternalEObject)logicalStep).eInverseRemove(this, MsePackage.LOGICAL_STEP__MSE_OCCURRENCES, LogicalStep.class, msgs);
				return basicSetLogicalStep((LogicalStep)otherEnd, msgs);
			case StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StepsPackage.PETRINETV1_NET_INITIALIZE__MSE:
				if (resolve) return getMse();
				return basicGetMse();
			case StepsPackage.PETRINETV1_NET_INITIALIZE__PARAMETERS:
				return getParameters();
			case StepsPackage.PETRINETV1_NET_INITIALIZE__RESULT:
				return getResult();
			case StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (derivedFeatureID) {
				case StepsPackage.PETRINETV1_NET_INITIALIZE__MSE: return MsePackage.MSE_OCCURRENCE__MSE;
				case StepsPackage.PETRINETV1_NET_INITIALIZE__PARAMETERS: return MsePackage.MSE_OCCURRENCE__PARAMETERS;
				case StepsPackage.PETRINETV1_NET_INITIALIZE__RESULT: return MsePackage.MSE_OCCURRENCE__RESULT;
				case StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP: return MsePackage.MSE_OCCURRENCE__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
			switch (derivedFeatureID) {
				case StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE: return StepsPackage.STEP__ENDING_STATE;
				case StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE: return StepsPackage.STEP__STARTING_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (baseFeatureID) {
				case MsePackage.MSE_OCCURRENCE__MSE: return StepsPackage.PETRINETV1_NET_INITIALIZE__MSE;
				case MsePackage.MSE_OCCURRENCE__PARAMETERS: return StepsPackage.PETRINETV1_NET_INITIALIZE__PARAMETERS;
				case MsePackage.MSE_OCCURRENCE__RESULT: return StepsPackage.PETRINETV1_NET_INITIALIZE__RESULT;
				case MsePackage.MSE_OCCURRENCE__LOGICAL_STEP: return StepsPackage.PETRINETV1_NET_INITIALIZE__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
			switch (baseFeatureID) {
				case StepsPackage.STEP__ENDING_STATE: return StepsPackage.PETRINETV1_NET_INITIALIZE__ENDING_STATE;
				case StepsPackage.STEP__STARTING_STATE: return StepsPackage.PETRINETV1_NET_INITIALIZE__STARTING_STATE;
				default: return -1;
			}
		}
		if (baseClass == SmallStep.class) {
