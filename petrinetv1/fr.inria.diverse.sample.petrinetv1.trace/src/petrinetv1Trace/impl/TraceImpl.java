 ...
 *   <li>{@link petrinetv1Trace.impl.TraceImpl#getPetrinetv1_Net_Run_Sequence <em>Petrinetv1 Net Run Sequence</em>}</li>
...
public class TraceImpl extends MinimalEObjectImpl.Container implements Trace {
	...
	/**
	 * The cached value of the '{@link #getPetrinetv1_Net_Run_Sequence() <em>Petrinetv1 Net Run Sequence</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPetrinetv1_Net_Run_Sequence()
	 * @generated
	 * @ordered
	 */
	protected EList<Petrinetv1_Net_Run> petrinetv1_Net_Run_Sequence;
	 ...
	 * @generated
	 */
	public EList<Petrinetv1_Net_Run> getPetrinetv1_Net_Run_Sequence() {
		if (petrinetv1_Net_Run_Sequence == null) {
			petrinetv1_Net_Run_Sequence = new EObjectResolvingEList<Petrinetv1_Net_Run>(Petrinetv1_Net_Run.class, this, Petrinetv1TracePackage.TRACE__PETRINETV1_NET_RUN_SEQUENCE);
		}
		return petrinetv1_Net_Run_Sequence;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Petrinetv1TracePackage.TRACE__PETRINETV1_NET_RUN_SEQUENCE:
				return getPetrinetv1_Net_Run_Sequence();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Petrinetv1TracePackage.TRACE__PETRINETV1_NET_INITIALIZE_SEQUENCE:
				...
				return;
			case Petrinetv1TracePackage.TRACE__PETRINETV1_NET_RUN_SEQUENCE:
				getPetrinetv1_Net_Run_Sequence().clear();
				getPetrinetv1_Net_Run_Sequence().addAll((Collection<? extends Petrinetv1_Net_Run>)newValue);
				return;
			case Petrinetv1TracePackage.TRACE__PETRINETV1_TRANSITION_FIRE_SEQUENCE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Petrinetv1TracePackage.TRACE__PETRINETV1_NET_RUN_SEQUENCE:
				return petrinetv1_Net_Run_Sequence != null && !petrinetv1_Net_Run_Sequence.isEmpty();
			case Petrinetv1TracePackage.TRACE__PETRINETV1_TRANSITION_FIRE_SEQUENCE:
