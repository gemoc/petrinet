...
public class NetImpl extends MinimalEObjectImpl.Container implements Net {
	...
	protected EClass eStaticClass() {
		return PetrinetV1Package.Literals.NET;
	}
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, PetrinetV1Package.NET__PLACES);
		}
		return places;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, PetrinetV1Package.NET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetV1Package.NET__PLACES:
				return ((InternalEList<?>)getPlaces()).basicRemove(otherEnd, msgs);
			case PetrinetV1Package.NET__TRANSITIONS:
